export default {
  pages: {
    ...
    data: [
      ...
      // APPS
      { title: "Demographs", url: "/dashboard/analytics",                          icon: "CheckSquareIcon",    is_bookmarked: false},
      { title: "Client History",                       url: "/apps/chat",                          icon: "MessageSquareIcon",  is_bookmarked: false},
      { title: "Complaints",                      url: "/apps/email",                         icon: "MailIcon",           is_bookmarked: false},
      { title: "PAtient History",                   url: "/apps/calendar/vue-simple-calendar",  icon: "CalendarIcon",       is_bookmarked: false},
      {title: "Test",            url: "/apps/eCommerce/shop",                icon: "ShoppingCartIcon",   is_bookmarked: false},
